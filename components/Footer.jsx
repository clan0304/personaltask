...
const Footer = () => {
  ...
  return (
    <div
      className={`h-[180px] w-full sm:h-[120px] bg-blue text-white flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-3 md:gap-4 text-xs md:text-sm lg:text-md xl:text-lg ${
